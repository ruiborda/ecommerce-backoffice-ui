...
export interface WarningPopProps {
    message: string;
    title?: string;
    class?: string;
}

export function WarningPop(props: WarningPopProps): JSX.Element {
    ...
    return (
        <div class={`flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 ${props.class || ""}`}>
            ...
            <div class="px-4 py-2 -mx-3">
                <div class="mx-3">
                    <span class="font-semibold text-yellow-400 dark:text-yellow-300">{title}</span>
