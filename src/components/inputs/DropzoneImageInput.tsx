...
export function DropzoneImageInput(props: DropzoneImageInputProps): JSX.Element {
  ...
  onMount(() => {
    if (inputEl?.form) {
      ...
      form.addEventListener("reset", clearState);
      onCleanup(() => form.removeEventListener("reset", clearState));
    }
  });
  ...
  return (
      <div>
        ...
        >
          ...
          >
            <>
              {/* Icono y textos cuando no hay imagen */}
              <svg
              ...
              >
                ...
                2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5
                1.5 0 00-1.5-1.5H3.75A1.5
                1.5 0 002.25 6v12a1.5
                1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0
